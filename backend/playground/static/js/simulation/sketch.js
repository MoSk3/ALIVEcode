...
const sketchSimulation = (s) => {
    ...
    s.preload = () => {
        //********************************* Images *********************************
        // Load des images
        carTop = s.loadImage('/static/images/simulation/misc/VoitureDessus.PNG')
        carTopG = s.loadImage('/static/images/simulation/misc/VoitureDessusG.PNG')
        carTopD = s.loadImage('/static/images/simulation/misc/VoitureDessusD.PNG')
        animatedCar = s.loadImage('/static/images/Voiture.gif')

        // Outils pour edit
        tools = s.loadImage('/static/images/simulation/editeur/tools.png')
        trash = s.loadImage('/static/images/simulation/editeur/trash.png')
        trashOpen = s.loadImage('/static/images/simulation/editeur/trashOpen.png')
        undo = s.loadImage('/static/images/simulation/editeur/undo.png')
        redo = s.loadImage('/static/images/simulation/editeur/redo.png')
        copy = s.loadImage('/static/images/simulation/editeur/copy.png')
        selectionOff = s.loadImage('/static/images/simulation/editeur/selectionOff.png')
        selectionOn = s.loadImage('/static/images/simulation/editeur/selectionOn.png')
        pasteOff = s.loadImage('/static/images/simulation/editeur/pasteOff.png')
        pasteOn = s.loadImage('/static/images/simulation/editeur/pasteOn.png')
        rotate_Clockwise_Img = s.loadImage('/static/images/simulation/editeur/rotate_clockwise.png')
        rotate_Counter_Clockwise_Img = s.loadImage('/static/images/simulation/editeur/rotate_counterclockwise.png')
        pinOn = s.loadImage('/static/images/simulation/editeur/pinOn.png')
        pinOff = s.loadImage('/static/images/simulation/editeur/pinOff.png')
        zoom_In = s.loadImage('/static/images/simulation/editeur/zoom_in.png')
        zoom_Out = s.loadImage('/static/images/simulation/editeur/zoom_out.png')
        linkOn = s.loadImage('/static/images/simulation/editeur/linkOn.png')
        linkOff = s.loadImage('/static/images/simulation/editeur/linkOff.png')
        information = s.loadImage('/static/images/simulation/editeur/information.png')

        // Routes
        road1 = s.loadImage('/static/images/simulation/routes/road1.jpg')
        tire_tracks = s.loadImage('/static/images/simulation/routes/tire_tracks.png')
        bridge = s.loadImage('/static/images/simulation/routes/bridge.png')

        // Terrains
        gazon = s.loadImage('/static/images/simulation/terrains/gazon.gif')
        grass = s.loadImage('/static/images/simulation/terrains/grass.jpg')
        mud = s.loadImage('/static/images/simulation/terrains/mud.jpg')
        sand = s.loadImage('/static/images/simulation/terrains/sand.jpg')
        mars_terrain = s.loadImage('/static/images/simulation/terrains/mars_surface.png')
        rock = s.loadImage('/static/images/simulation/terrains/rock.jpg')
        darkLava = s.loadImage('/static/images/simulation/terrains/darkLava.jpg')

        // Obstacles
        house = s.loadImage('/static/images/simulation/obstacles/house.png')
        stone = s.loadImage('/static/images/simulation/obstacles/stone.png')
        marsRock1 = s.loadImage('/static/images/simulation/obstacles/rocheMars1.png')
        marsRock2 = s.loadImage('/static/images/simulation/obstacles/rocheMars2.png')
        tree = s.loadImage('/static/images/simulation/obstacles/tree.png')
        water = s.loadImage('/static/images/simulation/obstacles/water.jpg')
        hole = s.loadImage('/static/images/simulation/obstacles/hole.png')
        mars_dome = s.loadImage('/static/images/simulation/obstacles/mars_dome.png')
        broken_rocket = s.loadImage('/static/images/simulation/obstacles/brokenRocket.png')
        black_hole = s.loadImage('/static/images/simulation/obstacles/black_hole.png')
        lava = s.loadImage('/static/images/simulation/obstacles/lava.png')
        mountains = s.loadImage('/static/images/simulation/obstacles/mountains.png')

        // Interactive
        coin = s.loadImage('/static/images/simulation/interactifs/coin.png')
        finishLine = s.loadImage('/static/images/simulation/interactifs/finishLine.png')
        flag = s.loadImage('/static/images/simulation/interactifs/flag.png')
        red_button = s.loadImage('/static/images/simulation/interactifs/red_button_unpressed.png')
        green_button = s.loadImage('/static/images/simulation/interactifs/green_button_pressed.png')
        treadmill = s.loadImage('/static/images/simulation/interactifs/treadmill.png')
        spring = s.loadImage('/static/images/simulation/interactifs/spring.png')
        repair_tools = s.loadImage('/static/images/simulation/interactifs/repair_tools.png')

        // Décorations
        satelitte = s.loadImage('/static/images/simulation/decorations/satelitte.png')
        alien = s.loadImage('/static/images/simulation/decorations/alien.gif')
        crack = s.loadImage('/static/images/simulation/decorations/crack.png')
        crackHole = s.loadImage('/static/images/simulation/decorations/holeCrack.png')
        ...
        //********************************* Audio **********************************
        coin_collect_audio = new Audio('/static/sounds/simulation/coin_collect.wav')
        level_complete_audio = new Audio('/static/sounds/simulation/level_complete.mp3')
        house_impact_audio = new Audio('/static/sounds/simulation/house_impact.mp3')
        tree_impact_audio = new Audio('/static/sounds/simulation/tree_impact.mp3')
        stone_impact_audio = new Audio('/static/sounds/simulation/stone_impact.mp3')
        water_impact_audio = new Audio('/static/sounds/simulation/water_impact.mp3')
        falling_down_audio = new Audio('/static/sounds/simulation/falling_down.mp3')
        lava_bubbles_audio = new Audio('/static/sounds/simulation/lava_bubbles.mp3')
        metal_impact_audio = new Audio('/static/sounds/simulation/metal_impact.mp3')

        s.dictAudios = {
            coin_collect_audio,
            level_complete_audio,
            house_impact_audio,
            tree_impact_audio,
            stone_impact_audio,
            water_impact_audio,
    ...
    s.setup = () => {
        ...
        s.green_button = green_button
        s.red_button = red_button
        s.level_complete_audio = level_complete_audio
    ...
    s.draw = () => {
        if (!s.pause) {
            ...
            if (s.isInsideCanvas()) {
                if (s.keyIsDown(32) || s.keyIsDown(17)) // Espace = s.keyIsDown(32)  Ctrl = s.keyIsDown(17)
                ...
                else if (s.pressedObject != null && s.editMode && !(s.keyIsDown(32) || s.keyIsDown(17))) {
            ...
            s.mouse.multiplyScalar(s.canvasCamera.scale / 1000).add(s.canvasCamera.pos)
            ...
            for (const [z_index, objects] of Object.entries(s.shapes))
        ...
        for (const [z_index, shapes] of Object.entries(s.shapes)) {
            for (const shape of shapes) {
                ...
                if (shape instanceof FixedObject || shape instanceof FixedTextObject) {
                    ...
                    collide = overlap(shape.vertices, [new Vector(s.mouseX - s.width / 2, -s.mouseY + s.height / 2)])
                } else {
                ...
                if (collide && !s.mobileDoublePressed) {
                    ...
                    if ((!s.isMobile && s.mouseIsPressed && !s.mouseWasPressed) || (s.mobilePressed && s.mobileClickDown)) {
                        ...
                        if (s.pressedObject != null && s.pressedObject == shape && !s.editMode) {
    ...
    s.clickDownGeneralMobile = () => {
        if (s.pressedObject != null) { // ClickDown du pressedObject dans Mobile
    ...
    s.mousePressedActions = () => {
        ...
        if (s.mobileDoublePressed)
            s.doubleTouchZoom()

        // Deplacer la camera version PC
        else if (s.mouseButton == s.CENTER || (s.keyIsDown(32) || s.keyIsDown(17)) || !s.editMode) { // Espace = s.keyIsDown(32)  Ctrl = s.keyIsDown(17)
            s.canvasCamera.move(new Vector((s.pmouseX - s.mouseX) * (s.canvasCamera.scale / 1000), (s.mouseY - s.pmouseY) * (s.canvasCamera.scale / 1000)))
        }
            ...
            if (s.pressedObject.isEditBox) {
                if (s.pressedObject.isRotateBox) {
                    ...
                    s.pressedObject.modifySize()
            }
            // Deplacer une forme
            else if (s.pressedObject.movable) {
                s.pressedObject.setPos(s.mouse.clone().substract(s.pressedObject.mouseOffset).roundVector(5), false) //Deplacer une seule forme
                if (s.selectionShape == s.pressedObject)
                    for (let selection of s.selectionShape.listSelect) //Deplacer les formes dans une selection
                        selection.setPos(s.selectionShape.pos.clone().substract(selection.shapeOffset).roundVector(1), false)
            }
    ...
    s.clickPressedObjectActions = () => {
        ...
        */
            ...
            if (!s.pressedObject.pinned) {
                ...
                if (s.trashCan.hovering || s.sideMenu.hovering) {
                    ...
                    if (shapeAlreadyExists == undefined)
                        s.movableShapes.push(s.storeShapeData(s.pressedObject, false, false, true))
                    else
                        s.movableShapes.splice(s.movableShapes.indexOf(shapeAlreadyExists), 1, s.storeShapeData(s.pressedObject, false, false, true));
                    ...
                    if (shapeAlreadyExists == undefined)
                        ...
                        s.movableShapes.splice(s.movableShapes.indexOf(shapeAlreadyExists), 1, s.storeShapeData(s.pressedObject));
                }
            }
        }
        ...
        if (!(s.pressedObject instanceof FixedObject || s.pressedObject instanceof FixedTextObject))
    ...
    s.deleteLastMovableObjectChildren = () => {
        ...
        if (s.lastMovableObject != null) {
            ...
            else if (!s.hoveredObject.isHelp)
                s.lastMovableObject.removeAllChildren()
        }
    }
    ...
    s.doubleTouchZoom = () => {
        ...
        s.canvasCamera.addScale(Math.round(dist2 - dist1) * 10 * (s.canvasCamera.scale / 1000))
        s.touche1 = newTouche1.clone()
        s.touche2 = newTouche2.clone()
    }
    ...
    s.lookForShapesCollisions = () => {
        ...
        for (const [z_index, shapes] of Object.entries(s.shapes)) {
            for (let shape of shapes) {
                ...
                for (const [z_index, shapesCompare] of Object.entries(s.shapes)) {
    ...
    s.drawGrid = () => {
        ...
        s.strokeWeight(0.5);
        let step = 50
        let w = Math.round(s.width * (s.canvasCamera.scale / 1000) / step * 2) * step * 2
        let h = Math.round(s.height * (s.canvasCamera.scale / 1000) / step * 2) * step * 2
        let vlines = w / step
        let hlines = h / step

        for (let i = 0; i < vlines; i++) {
            if ((i * step - w / 2 + Math.ceil(s.canvasCamera.pos.x <= 0 ? (s.canvasCamera.pos.x / step) : (s.canvasCamera.pos.x / step - 1)) * step) % (step * 5) == 0)
                s.stroke(100)
            s.line((i * step - w / 2 - s.canvasCamera.pos.x % step) * (1000 / s.canvasCamera.scale), (s.canvasCamera.pos.y % step - h / 2) * (1000 / s.canvasCamera.scale),
                (i * step - w / 2 - s.canvasCamera.pos.x % step) * (1000 / s.canvasCamera.scale), (s.canvasCamera.pos.y % step + h / 2) * (1000 / s.canvasCamera.scale))
            s.stroke(200)
        }
        for (let i = 0; i < hlines; i++) {
            if ((i * step - h / 2 + Math.ceil(s.canvasCamera.pos.y <= 0 ? (s.canvasCamera.pos.y / step) : (s.canvasCamera.pos.y / step - 1)) * step) % (step * 5) == 0)
                s.stroke(100)
            s.line((-w / 2 - s.canvasCamera.pos.x % step) * (1000 / s.canvasCamera.scale), (s.canvasCamera.pos.y % step - i * step + h / 2) * (1000 / s.canvasCamera.scale),
                (w / 2 - s.canvasCamera.pos.x % step) * (1000 / s.canvasCamera.scale), (s.canvasCamera.pos.y % step - i * step + h / 2) * (1000 / s.canvasCamera.scale))
            s.stroke(200)
        }
    }
    ...
    s.keyPressed = () => {
        ...
        if (s.carController && s.selectedCar != null && s.selectedCar < s.cars.length) {
            // R
    ...
    s.addObjectToScene = (obj, z_index = 0) => {
        ...
        let tempDict = {}
        for (sortedKey of sortedKeys) {
            tempDict[sortedKey] = s.shapes[sortedKey]
        }
        s.shapes = tempDict
    }

    s.deleteShape = (shape, recursively = true, copiedFromContextMenu = false) => {
        // À CHANGER
        ...
        if (copiedFromContextMenu) {
            ...
            s.movableShapes.push(s.storeShapeData(s.lastMovableObject, false, false, true))
        }
    }

    s.spawnRect = (x, y, w, h, z_index = 0) => {
        let shape = s.spawnShape(z_index, [-w / 2, h / 2], [w / 2, h / 2], [w / 2, -h / 2], [-w / 2, -h / 2])
    ...
    s.spawnTerrain = (w, h, frictionCoef = 1, z_index = 0) => {
        let terrain = new Terrain(s, frictionCoef, [-w / 2, h / 2], [w / 2, h / 2], [w / 2, -h / 2], [-w / 2, -h / 2])
        s.addObjectToScene(terrain, z_index)
        return terrain
    }

    s.spawnRoad = (w, h, minimumSize, z_index = 0) => {
        let road = new Road(s, minimumSize, [-w / 2, h / 2], [w / 2, h / 2], [w / 2, -h / 2], [-w / 2, -h / 2])
        s.addObjectToScene(road, z_index)
        return road
    }

    s.spawnObstacle = (w, h, isGameOver, z_index = 0) => {
        let obstacle = new Obstacle(s, isGameOver, [-w / 2, h / 2], [w / 2, h / 2], [w / 2, -h / 2], [-w / 2, -h / 2])
        s.addObjectToScene(obstacle, z_index)
        return obstacle
    }

    s.spawnInteractiveObject = (w, h, isCoin, isObjectif, isButton, z_index = 0) => {
        let interaction = new InteractiveObject(s, isCoin, isObjectif, isButton, [-w / 2, h / 2], [w / 2, h / 2], [w / 2, -h / 2], [-w / 2, -h / 2])
    ...
    s.spawnFixedRect = (x, y, w, h, z_index = 500) => {
        return s.spawnFixedObject(z_index,
            [x - w / 2, y + h / 2],
            [x + w / 2, y + h / 2],
            [x + w / 2, y - h / 2],
            [x - w / 2, y - h / 2])
    ...
    s.stringify = (lines = []) => {
        ...
        let ignores = ["s", "img", "length", "colliding", "hovering", "camera", "forward", "dir", "shape", "children", "parent",
            "strokeColor", "alwaysStroke", "scaleWithCamera", "carInteraction", "isEditBox",
            "bounds", "middle", "left", "top", "right", "bottom", "oldLeft", "oldTop", "oldRight", "oldBottom", "oldMiddle",
            "oldWidth", "oldHeight", "mouseOffset", "isRotateBox", "cursor", "leftEdgeClickDown", "upEdgeClickDown",
            "rightEdgeClickDown", "bottomEdgeClickDown"]
            ...
            for (i; i < shapes.length; i++) {
                if (shapes[i]?.movable && !shapes[i]?.isHelp) {
                    ...
                    if (shapes[i].class == "Obstacle") {
                        ...
                        cloned = new InteractiveObject(s, shapes[i].isCoin, shapes[i].isObjectif, shapes[i].isButton, ...points)
                        s.addInteractiveObject(cloned)
                        for (let j = 0; j < shapes[i].linkedId.length; j++) cloned.linkedId.push(shapes[i].linkedId[j])
                    }
                    else if (shapes[i].class == "TextObject")
                        cloned = new TextObject(s, shapes[i].text, shapes[i].size, 0, 0, shapes[i].color)
                    else
                        cloned = new Shape(s, ...points)
                    ...
                    if (shapes[i].hasTexture)
                        ...
                        cloned.color = shapes[i].color // A CHANGER CAR CAUSE DES ERREURS (fonctionne juste avec les colors en string ex: "red", "blue", "cyan"; le reste fait erreur)

                    if (shapes[i].soundOnCollision)
                        cloned.setSoundOnCollision(s.dictAudios[shapes[i].soundOnCollisionName])
                    ...
                    if (thisCar != null) {
                        ...
                        let initializedCar = Object.assign(new Car(s, thisCar.shape), thisCar)
                        s.cars.push(initializedCar)
                    }
                    else
                        s.movableShapes.push(s.storeShapeData(cloned))
    ...
    s.getShapeById = (id) => {
        for (let [z_index, shapes] of Object.entries(s.shapes)) {
            for (let shape of shapes) {
    ...
    s.resize = (w = null, h = null) => {
        if (w != null && h != null) {
            if (w != s.width || h != s.height) {
                let oldWidth = s.width
                let oldHeight = s.height
                s.resizeCanvas(w, h)
                /*for (const [z_index, shapes] of Object.entries(s.shapes)) {
                    for (let shape of shapes) {
                ...
                if (s.editorButton != null)
                    s.editorButton.setPos(new Vector(s.width / 2 - 35, -s.height / 2 + 95), false)
                if (s.robotConnectButton != null)
                    s.robotConnectButton.setPos(new Vector(s.width / 2 - 35, -s.height / 2 + 35), false)
            }
        }
