...
import { Layout, LevelTypes, SerializedLevel, BaseLayoutObj } from './typesSimulation';
...
export class Serializer {
    ...
    static serialize(s: any, type: LevelTypes, initialCode: string[]): SerializedLevel | void {
        const layout: Layout = {
