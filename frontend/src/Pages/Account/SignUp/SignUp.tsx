				...
				{userType === USER_TYPES.PROFESSOR ? (
					<Form.Row>
						<Form.Group as={Col}>
							...
							/>
							{errors.professor?.first_name?.type === 'required' && "Un nom est requis"}
						</Form.Group>
						<Form.Group as={Col}>
							...
							/>
							{errors.professor?.last_name?.type === 'required' && "Un nom de famille est requis"}
						</Form.Group>
					</Form.Row>
				) : (
					<>
						<Form.Group>
							...
							/>
							{errors.student?.name?.type === 'required' && "Un pseudonyme est requis"}
						</Form.Group>
						<Form.Group>
							...
							/>
							{errors.student?.scholarity?.type === 'required' && "Le niveau scholaire est requis"}
						</Form.Group>
					</>
				)}
				<Form.Group>
