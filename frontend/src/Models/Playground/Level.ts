...
export class CodeLevel {
	constructor(public initialCode: string[], public tests: string[]) {}
}

export class AiLevel {
	constructor(public initialCode: string[]) {}
}

export class SimulationLevel {
	constructor(public layout: Layout, public initialCode: string[]) {}
}
